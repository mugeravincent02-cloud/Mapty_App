...
class App {
  ...
  _loadMap(position) {
    ...
    const coords5 = [latitude, longitude];
    this.#map = L.map('map').setView(coords5, this.#mapZoomLevel);
  ...
  _renderWorkout(workout) {
    ...
    <li class="workout workout--${workout.type}" data-id="${workout.id}">
        ...
        <div class="workout__details">
          ...
          <span class="workout__value">${workout.document}</span>
